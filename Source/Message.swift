...
public struct Message {
  ...
  public init(title: String, textColor: UIColor = UIColor.white, backgroundColor: UIColor = UIColor.lightGray, images: [UIImage]? = nil, font: UIFont? = FontList.Whistle.title) {
    self.title = title
